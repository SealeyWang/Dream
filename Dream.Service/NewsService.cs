...
namespace Dream.Service
{
    public class NewsService
    {
        ...
        public String AddNews(News n)
        {
            ...
            String query = "INSERT INTO [news] (newscontent,newstitle,newstime) VALUES (@newscontent,@newstitle,@newstime);";
            ...
            command.Parameters.AddWithValue("@newscontent", n.newscontent);
            command.Parameters.AddWithValue("@newstitle", n.newstitle);
            command.Parameters.AddWithValue("@newstime", n.newsTime);
